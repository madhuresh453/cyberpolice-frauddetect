      ...
      body: SafeArea(child: Padding(padding: const EdgeInsets.all(16), child: Column(children: [
        ...
        Container(padding: const EdgeInsets.all(8), decoration: BoxDecoration(color: AppTheme.cardBg, borderRadius: BorderRadius.circular(10), border: Border.all(color: AppTheme.borderColor)),
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
            _pipeItem('Audio'), const Icon(Icons.arrow_forward, size: 14, color: AppTheme.textDim),
            _pipeItem('STT'), const Icon(Icons.arrow_forward, size: 14, color: AppTheme.textDim),
            _pipeItem('Keywords'), const Icon(Icons.arrow_forward, size: 14, color: AppTheme.textDim),
            _pipeItem('Intent'), const Icon(Icons.arrow_forward, size: 14, color: AppTheme.textDim),
            _pipeItem('Risk'),
          ])),
        const SizedBox(height: 16),
