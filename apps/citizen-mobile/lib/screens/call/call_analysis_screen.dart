      ...
      body: SafeArea(child: Padding(padding: const EdgeInsets.all(24), child: Column(children: [
        ...
        Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: AppTheme.cardBg, borderRadius: BorderRadius.circular(10), border: Border.all(color: AppTheme.borderColor)),
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
            _pipelineItem('Speech', Icons.hearing), Icon(Icons.arrow_forward, size: 16, color: AppTheme.textDim),
            _pipelineItem('Text', Icons.text_fields), Icon(Icons.arrow_forward, size: 16, color: AppTheme.textDim),
            _pipelineItem('NLP', Icons.psychology), Icon(Icons.arrow_forward, size: 16, color: AppTheme.textDim),
            _pipelineItem('Risk', Icons.shield), Icon(Icons.arrow_forward, size: 16, color: AppTheme.textDim),
